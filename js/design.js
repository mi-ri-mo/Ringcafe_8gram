...
function onChangeDesign(value) {
    let ringImage = ['img/design-img/ring01.png', 'img/design-img/ring02.png', 'img/design-img/ring03.png', 'img/design-img/ring04.png', 'img/design-img/ring05.png', 'img/design-img/ring06.png', 'img/design-img/ring07.png', 'img/design-img/ring08.png', 'img/design-img/ring09.png', 'img/design-img/ring09.png'];
    let ringDetail = ['인기 반지 1위','인기 반지 2위','인기 반지 3위','인기 반지 4위','인기 반지 5위','인기 반지 6위','인기 반지 7위','인기 반지 8위','인기 반지 9위', '#'];
    let braceletImage = ['img/design-img/bracelet01.png', 'img/design-img/bracelet02.png', 'img/design-img/bracelet03.png', 'img/design-img/bracelet04.png', 'img/design-img/bracelet05.png', 'img/design-img/bracelet06.png', 'img/design-img/bracelet07.png', 'img/design-img/bracelet08.png', 'img/design-img/bracelet09.png', 'img/design-img/bracelet09.png'];
